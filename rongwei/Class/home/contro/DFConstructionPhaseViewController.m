//
//  DFConstructionPhaseViewController.m
//  rongwei
//
...
@interface DFConstructionPhaseViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation DFConstructionPhaseViewController
...
- (void)getStyle
{
    [[DFNetworkTool shareInstance] requestWithMethod:GHRequestMethod_GET withUrl:ConstructionStage withParameter:nil withLoadingType:GHLoadingType_ShowLoading withShouldHaveToken:YES withContentType:GHContentType_Formdata completionBlock:^(BOOL isSuccess, NSString * _Nullable msg, id  _Nullable response) {
