...
@interface DFPageContentView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation DFPageContentView
...
//    [cell.contentView.subviews makeObjectsPerformSelector:@selector(removeFromSuperview)];
    UIViewController *childVC = self.childsVCs[indexPath.item];
        childVC.view.frame = CGRectMake(0, 0, ScreenW, CGRectGetMaxY(self.frame));//cell.contentView.bounds;
